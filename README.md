...
- Client code:
  ...
  - [x] Reducers & Actions Working
    ...
    - [N/A (used a seperate reducer for everything)] Reducers are using spread correctly (to keep old data, while adding new)
...
Nice Cassen. Your app is welcoming. Upon opening the app, it is made apparent to me that I am actually taking a survery, rather than being thrown into it with a cold question. Reducers are nicely labeled and tell me what is happening everytime they fire. I found a couple cases of whitespacing that could be deleted, but that's about it. Nice grasp of material UI. The App looks good!
